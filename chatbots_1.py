...
if __name__ == '__main__':
    pirate = ooze.resolve("pirate_chatbot")
    print(pirate.text("How's your day going in 10 words or less"))

    pig = ooze.resolve("piglatin_chatbot")
    print(pig.text("How's your day going in 10 words or less"))
